...
from llamacu.speculative.cascade_eagle3_spec_quant.csc_eagle3_w4a16_gm_spec_w4a16_gm import CascadeEagle3W4A16GMSpecW4A16GM
...
if __name__ == "__main__":
    ...
    model = CascadeEagle3W4A16GMSpecW4A16GM(
