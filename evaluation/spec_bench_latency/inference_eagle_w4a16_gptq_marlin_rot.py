...
from llamacu.speculative.eagle_base_quant.eagle_base_w4a16_marlin_gptq_rot_latency import W4A16GPTQMarlinLLM_with_eagle_rot_Latency
...
def eagle_w4a16_rot_forward(inputs, model, tokenizer, max_new_tokens, max_length, teminators):
    ...
    # generate
    output_ids, accept_length_list, model_step, decode_time, latency_time = model.generate(
        input_ids=input_ids,
    ...
    return output_ids, new_token, model_step, accept_length_list, decode_time, latency_time
...
if __name__ == "__main__":
    ...
    model = W4A16GPTQMarlinLLM_with_eagle_rot_Latency(
