...
from llamacu.speculative.eagle_base_quant.eagle_base_w4a16_marlin_gptq_latency import W4A16GPTQMarlinLLM_with_eagle_Latency
...
if __name__ == "__main__":
    ...
    model = W4A16GPTQMarlinLLM_with_eagle_Latency(
