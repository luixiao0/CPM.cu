...
from llamacu.speculative.eagle3_base_quant.eagle3_base_w4a16_marlin_gptq_latency import W4A16GPTQMarlinLLM_with_eagle3_Latency
...
if __name__ == "__main__":
    ...
    model = W4A16GPTQMarlinLLM_with_eagle3_Latency(
