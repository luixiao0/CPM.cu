...
from llamacu.speculative.cascade_eagle3_spec_quant.csc_eagle3_w4a16_gm_spec_w4a16_gm_latency import CascadeEagle3W4A16GMSpecW4A16GMLatency
...
def cascade_spec_w4a16_forward(inputs, model, tokenizer, max_new_tokens, max_length, teminators):
    ...
    # generate
    output_ids, accept_length_list, model_step, decode_time, latency_time, cascade_accept_length_list = model.generate(
        input_ids=input_ids,
    ...
    return output_ids, new_token, model_step, accept_length_list, decode_time, latency_time, cascade_accept_length_list.tolist()
...
if __name__ == "__main__":
    ...
    model = CascadeEagle3W4A16GMSpecW4A16GMLatency(
