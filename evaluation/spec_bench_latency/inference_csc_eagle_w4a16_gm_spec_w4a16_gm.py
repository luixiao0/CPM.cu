...
from llamacu.speculative.cascade_spec_quant.csc_eagle_w4a16_gm_spec_w4a16_gm_latency import CascadeEagleW4A16GMSpecW4A16GMLatency
...
if __name__ == "__main__":
    ...
    model = CascadeEagleW4A16GMSpecW4A16GMLatency(
