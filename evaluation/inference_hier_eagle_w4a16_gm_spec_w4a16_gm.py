...
from llamacu.speculative.hier_spec_quant.hier_eagle_w4a16_gm_spec_w4a16_gm import HierEagleW4A16GMSpecW4A16GM
...
if __name__ == "__main__":
    ...
    model = HierEagleW4A16GMSpecW4A16GM(
    ...
    run_eval(
        model=model,
        tokenizer=tokenizer,
        forward_func=hier_spec_w4a16_forward,
