...
struct Model {
    ...
    virtual void draft(int32_t *tree_draft_ids, int32_t *tree_position_ids, int32_t *cache_length, uint64_t* attn_mask) = 0;
...
struct ModelImpl : Model {
    ...
    void draft(int32_t *tree_draft_ids, int32_t *tree_position_ids, int32_t *cache_length, uint64_t* attn_mask) { throw std::runtime_error("Draft is not supported"); }
