...
#include "../memory.cuh"
#include "../norm.cuh"
#include "w4a8_per_chn_attn.cuh"
#include "w4a8_per_chn_ffn.cuh"
#include "../kvcache.cuh"
#include <cuda_runtime.h>

template <typename T>
struct W4A8PerChnLayer {
    W4A8PerChnAttention<T> *attn;
    W4A8PerChnGatedFFN<T> *ffn;
    ...
    W4A8PerChnLayer(
        ...
        this->attn = new W4A8PerChnAttention<T>(hidden_size, num_attention_heads, num_key_value_heads, head_dim, rms_norm_eps);
        this->ffn = new W4A8PerChnGatedFFN<T>(hidden_size, intermediate_size, rms_norm_eps);
    }
