...
template <typename T>
struct CascadeEagle3W4A16GMSpecW4A16GMEa3HeadImpl: Model {
    ...
    int cur_ea_accept_nums_size;
     ...
     CascadeEagle3W4A16GMSpecW4A16GMEa3HeadImpl(
        W4A16GPTQMarlinModelImpl<T>* model,
    ...
    void draft(int32_t *tree_draft_ids, int32_t *tree_position_ids, int32_t *cache_length, uint64_t*, int32_t*) {
        ...
        while (this->cur_draft_length < min_draft_length){
            ...
            gather_int(calc_stream, this->ea_tree_size, this->ea_d2t, this->topk_func->topk_pos, this->topk_func->topk_pos);
