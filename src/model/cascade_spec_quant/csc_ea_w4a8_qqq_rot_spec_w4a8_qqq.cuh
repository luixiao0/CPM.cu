...
template <typename T>
struct CascadeEagleRotW4A8QQQSpecW4A8QQQImpl: Model {
    ...
    W4A8QQQModelImpl<T>* draft_model;
    ...
    CascadeEagleRotW4A8QQQSpecW4A8QQQImpl(
        W4A8QQQModelImpl<T>* model,
        ...
        this->model = model;
        this->draft_model = new W4A8QQQModelImpl<T>(
            0,
            nullptr,
            draft_vocab_size,
