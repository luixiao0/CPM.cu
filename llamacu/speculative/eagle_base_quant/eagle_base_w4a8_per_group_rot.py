...
from ..tree_drafter_base_quant.tree_drafter_w4a8_per_group import W4A8PerGroupLLM_with_tree_drafter

import torch


class W4A8PerGroupLLM_with_eagle_rot(W4A8PerGroupLLM_with_tree_drafter):
    def __init__(self,
                 eagle_path,
                 base_path,
                 num_iter=6,
        ...
        C.init_eagle_w4a8_per_group_rot_model(
