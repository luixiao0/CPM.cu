...
mc_sim_7b_31 = [[0], [0, 0], [1], [0, 1], [2], [0, 0, 0], [1, 0], [0, 2], [3], [0, 3], [4], [0, 4], [2, 0], [0, 5], [0, 0, 1], [5],  [0, 1, 0], [1, 1],  [0, 0, 2], [3, 0],  [1, 0, 0], [0, 2, 0], [1, 2], [0, 0, 3], [4, 0], [2, 1], [5, 0],  [0, 1, 1],  [0, 3, 0], [1, 3],  [2, 0, 0]]
...
class W4A8PerChnLLM_with_medusa(W4A8PerChnLLM):
    def __init__(self,
                 medusa_path,
                 base_path,
                 medusa_num_heads=4,
