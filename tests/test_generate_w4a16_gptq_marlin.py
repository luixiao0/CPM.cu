...
from llamacu.speculative.eagle_base_quant.eagle_base_w4a16_marlin_gptq_rot import W4A16GPTQMarlinLLM_with_eagle_rot
...
# path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-8B-Instruct-4bit-128g-pileval-mse-desc-static_group_default_merge"
# path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-8B-Instruct-4bit-gchn-pileval-mse-desc-static_group_default_merge"

# path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-8B-Instruct-4bit-128g-pileval-mse-gptq_marlin_merge"
# rotation
# path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-8B-Instruct-rotation-4bit-128g-pileval-mse-desc-static_group_default_merge"
path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-70B-Instruct-qqq-rotation-4bit-128g-pileval-mse_merge"
# path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-70B-Instruct-qqq-rotation-4bit-128g-pileval-mse_merge"
# path = "/home/ydzhang/checkpoints/AutoGPTQ/Meta-Llama-3-70B-Instruct-qqq-rotation-4bit-gchn-pileval_merge"
...
eagle_rot_path = "/home/ydzhang/checkpoints/yuhuili/EAGLE-LLaMA3-Instruct-8B-w4a8_rotation"
# eagle_rot_path = "/home/ydzhang/checkpoints/yuhuili/EAGLE-LLaMA3-Instruct-70B-qqq_rotation"
# eagle_rot_path =  "/home/ydzhang/checkpoints/yuhuili/EAGLE-LLaMA3-Instruct-70B-qqq_rotation"
...
cuda_graph = True
num_generate = 1024
model_type = ["base", "medusa", "eagle", "eagle_rot"][3]
Bench = True
...
# TODO: to delete, now is simulate the casacade 
# input_ids = torch.cat([input_ids, torch.tensor([[334]]).cuda().int()], dim=1)
# input_ids = torch.cat([input_ids, torch.tensor([[13317,    25, 59805, 37957]]).cuda().int()], dim=1)
# input_ids = torch.cat([input_ids, torch.tensor([[13317,    25, 59805, 37957,   389, 75483, 17961,  8423,   271, 31765,510, 10254, 32496,]]).cuda().int()], dim=1)
# input_ids = torch.cat([input_ids, torch.tensor([[13317,    25, 59805, 37957,   389, 75483, 17961,  8423,   271, 31765]]).cuda().int()], dim=1)
# print("input ids")
# print(input_ids)
...
if model_type == "medusa":
    ...
    our_generate = lambda: llm.generate(input_ids, num_generate, teminators=teminators)
elif model_type == "eagle_rot":
    llm = W4A16GPTQMarlinLLM_with_eagle_rot(eagle_rot_path, path, dtype=dtype, memory_limit=0.8, num_iter=6, tree_size=60, cuda_graph=cuda_graph)
    our_generate = lambda: llm.generate(input_ids, num_generate, teminators=teminators)
else:
...
if model_type == "eagle" or model_type == "eagle_rot" or model_type == "medusa":
    import numpy as np
