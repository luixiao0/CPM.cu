...
from MagicDec.Engine.backend_w8a8_qserve import LMBackend
...
fast_path="/home/ydzhang/checkpoints/neuralmagic/Meta-Llama-3-8B-Instruct-quantized.w8a8-test/model_qserve.pth"
...
with torch.no_grad():
    ...
    logits = engine.inference(input_ids)[0]
