...
if model_type == "spec":
    ...
    llm = W4A16GMSpecW4A16GM(drafter_path=draft_path, base_path=path, draft_num=6, dtype=dtype, chunk_length=chunk_length, memory_limit=0.8, cuda_graph=cuda_graph , draft_cuda_graph= draft_cuda_graph)
else:
